export default {
    ...
    <h3 v-if="!edit">{{note.info.title}}</h3>
        ...
        <iframe  width="250px" class="note-video" :src="note.info.txt" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
